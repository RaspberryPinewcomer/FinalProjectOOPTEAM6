...
public class GeometryIO {
	...
	public static double surfaceAreaOfRightCircularPrism(double base, double height, double radius, double circumference) {
		...
		if  (radius <= 0 && circumference <=0) {
			throw new IllegalArgumentException("Radius and circumference cannot both be zero");
	...
	public static double volumeOfsquarePyramid(double base, double height) {
		...
		double fracThird = 1/3;
		double baseArea = base * base;
		double solution = fracThird * baseArea * height;
	...
	public static double volumeOfRightCircularCone(double areaOfBase, double height, double radius) {
		...
		if( areaOfBase <= 0 && radius <=0 ) {
			throw new IllegalArgumentException("You must either give me a radius or a area for the base greater than zero.");
		...
		double fracThird = 1 / 3;
		double solution = fracThird * areaOfBase * height;
	...
	public static double volumeOfSphere(double radius) {
		...
		double fracThird = 4 / 3;
		double cubeRaid = radius * radius * radius;
		double solution = fracThird * Math.PI * cubeRaid;
